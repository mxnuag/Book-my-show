...
class City {
public:
    virtual void show_cinemas() = 0;
    virtual void show_halls(int cinema_choice) = 0;
    virtual void show_movies(int hall_choice) = 0;
};
...
public:
    ...
    void show_halls(int cinema_choice) override {
        t1.user_choice_city_name = "Delhi";
        switch (cinema_choice) {
        case 1: delhi_cinema_name = "PVR Plaza"; break;
        case 2: delhi_cinema_name = "DLF Cinema"; break;
        case 3: delhi_cinema_name = "Amba Cinema"; break;
        case 4: delhi_cinema_name = "Gold Cinema"; break;
        default: cout << "Invalid choice"; return;
        }

        t1.user_choice_cinema_name = delhi_cinema_name;
        cout << "Selected Cinema: " << delhi_cinema_name << "\n";
        cout << "1. Hall A\n";
        cout << "2. Hall B\n";
        cout << "Enter choice: ";
        int hall_choice;
        cin >> hall_choice;
        show_movies(hall_choice);
    }

    void show_movies(int hall_choice) override {
        t1.user_choice_hall_name = (hall_choice == 1) ? "A" : "B";
        cout << "Movies in Hall " << t1.user_choice_hall_name << "\n";
        cout << "1. Spider-Man\n";
        cout << "2. West Side Story\n";
        cout << "Enter choice: ";
        int movie_choice;
        cin >> movie_choice;
        select_movie(movie_choice);
    }

    void select_movie(int movie_choice) {
        switch (movie_choice) {
        case 1: movie_name = "Spider-Man"; break;
        case 2: movie_name = "West Side Story"; break;
        default: cout << "Invalid choice"; return;
        }
...
public:
    void select_city() {
        ...
        City* city = nullptr;
        switch (choice) {
        case 1: city = new Delhi(); break;
        // case 2: city = new Hyderabad(); break;
        // case 3: city = new Chennai(); break;
        // case 4: city = new Pune(); break;
        default: cout << "Invalid choice"; return;
        }
